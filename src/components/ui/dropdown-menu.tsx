...
function DropdownMenuCheckboxItem({
  ...
  return (
    <DropdownMenuPrimitive.CheckboxItem
      ...
      // exactOptionalPropertyTypes: the prop is omitted rather than passed
      // as undefined because Radix types it without an explicit undefined.
...
// The highlight colours the item itself and lets that colour inherit: plain
// text and lucide icons follow it. Do not add a `**:text-accent-foreground`
// force rule here — the registry emits one, and it also repaints the
// descendants that carry a colour of their own, so a brand mark inside an item
// would be flattened to plain foreground text on highlight.
